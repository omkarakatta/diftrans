...
The goal of the `diftrans` package is to compute the differences-in-transports estimator introduced in Daljford, Hu, Pouliot, and Xiao (2020). Currently, the package is in development.
