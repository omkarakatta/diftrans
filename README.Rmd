...
You can install the `diftrans` from [GitHub](https://github.com/omkarakatta/diftrans) with:
...
```{r echo = F}
ggplot(pre_treated, aes(x = x, y = count)) +
...
<div class = "column-right">
```{r echo = F}
ggplot(post_treated, aes(x = x, y = count)) +
  geom_bar(stat = "identity") +
  theme_bmp(sizefont = NULL,
            axissizefont = NULL) +
  scale_x_continuous(breaks = support,
...
In this trivial example, we should expect that the transport cost is 100% because
...
<div class="column-right">
```{r echo = F}
ggplot(pre_control, aes(x = x, y = count)) +
  geom_bar(stat = "identity") +
  theme_bmp(sizefont = NULL,
            axissizefont = NULL) +
  scale_x_continuous(breaks = support,
...
<div class="column-right">
```{r echo = F}
ggplot(post_control, aes(x = x, y = count)) +
  geom_bar(stat = "identity") +
  theme_bmp(sizefont = NULL,
            axissizefont = NULL) +
  scale_x_continuous(breaks = support,
